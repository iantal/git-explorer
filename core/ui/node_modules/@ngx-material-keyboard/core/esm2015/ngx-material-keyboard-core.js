...
class MatKeyboardKeyComponent {
    ...
    deleteSelectedText() {
        const /** @type {?} */ value = this.inputValue;
        let /** @type {?} */ caret = this.input ? this._getCursorPosition() : 0;
        let /** @type {?} */ selectionLength = this._getSelectionLength();
        ...
        const /** @type {?} */ headPart = value.slice(0, caret);
        const /** @type {?} */ endPart = value.slice(caret + selectionLength);
    ...
    replaceSelectedText(char) {
        const /** @type {?} */ value = this.inputValue;
        const /** @type {?} */ caret = this.input ? this._getCursorPosition() : 0;
        const /** @type {?} */ selectionLength = this._getSelectionLength();
        const /** @type {?} */ headPart = value.slice(0, caret);
        const /** @type {?} */ endPart = value.slice(caret + selectionLength);
